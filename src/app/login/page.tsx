                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="password"
                      name="password"
                      className="block w-full rounded-lg border border-gray-200 px-4 py-3 text-sm focus:border-green-500 focus:ring-green-500 disabled:pointer-events-none disabled:opacity-50"
                ...
                <div className="flex items-center">
                  <div className="flex">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="mt-0.5 shrink-0 rounded border-gray-200 text-green-500 focus:ring-blue-500"
                    />
                  </div>
                  <div className="ms-3">
                    <label
